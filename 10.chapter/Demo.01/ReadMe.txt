========================================================================
		ActiveX Control DLL : JUNEDRAWING
========================================================================

ControlWizard has created this project for your JUNEDRAWING ActiveX Control
...
that make up your JUNEDRAWING ActiveX Control DLL.
...
JuneDrawingCtl.h
	This file contains the declaration of the CJuneDrawingCtrl C++ class.

JuneDrawingCtl.cpp
	This file contains the implementation of the CJuneDrawingCtrl C++ class.

JuneDrawingPpg.h
	This file contains the declaration of the CJuneDrawingPropPage C++ class.

JuneDrawingPpg.cpp
	This file contains the implementation of the CJuneDrawingPropPage C++ class.

JuneDrawingCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CJuneDrawingCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file JuneDrawing.rc.
